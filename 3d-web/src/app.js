...
Ammo().then((Ammo) => {
  ...
  function loadRyanText() {
    ...
    text_loader.load('./src/jsm/MiSans_Bold.json', function (font) {
      var xMid, text;
      ...
      var geometry = new THREE.TextGeometry("Qidushang's", {
        font: font,
        size: 3,
        height: 0.5,
        curveSegments: 12,
  ...
  function loadEngineerText() {
    ...
    text_loader.load('./src/jsm/MiSans_Bold.json', function (font) {
      ...
      var geometry = new THREE.TextGeometry('3D网站', {
        font: font,
        size: 1.5,
        height: 0.5,
        curveSegments: 20,
  ...
  function start() {
    ...
    createBillboard(
      ...
      2.5,
      -78,
      billboardTextures.indexTexture,
      URL.index,
      Math.PI * 0.17
    );
    ...
    floatingLabel(19.125, 4.5, -70, 'QRcode');
    ...
    // 板块文字
    simpleText(-50, 0.01, -5, '能力', 3);
    simpleText(-42, 0.01, -30, '项目', 3);
    simpleText(61, 0.01, -15, '背景', 3);
