        ...
        <div v-if="userStore.isLoggedIn" class="comment-input-wrapper">
          ...
          <div class="comment-input-box">
            <RichTextEditor
              ...
              mode="simple"
              :height="150"
              placeholder="写下你的评论，支持加粗、表情、链接、代码等富文本格式..."
            />
            <div class="comment-actions">
              <button class="btn btn-primary btn-sm" @click="submitComment" :disabled="isCommentEmpty">
                发表评论
              </button>
            </div>
          </div>
        ...
        <div class="comments-list">
          ...
          >
            ...
            <div class="comment-content">
              ...
              <div class="comment-text rich-text-content" v-html="comment.content"></div>
...
// 评论富文本是否为空（去除 HTML 标签后判断）
const isCommentEmpty = computed(() => {
  const plainText = newComment.value.replace(/<[^>]*>/g, '').trim()
